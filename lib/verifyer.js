...
var Verifyer = (function() {
     ...
     * as an ok domain.
     *
     * @param domain name that shall be registred.
     */
     ...
     *
     * @param domain that shall be verified
     * @return true/false if the domain are among the ok domains or not
     */
     ...
     *
     * @return an array of all ok domains
     */
