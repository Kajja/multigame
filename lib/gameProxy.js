...
var GameProxy = (function(){
     ...
     *
     * @param {String} url - url of the multigame server
     * @param {String} gameId - id of the game to connect to
     * @param {String} clientType - type of client i.e. player or observer
     */
     ...
     *
     * @param {Object} observer - object that shall observer the GameProxy object
     */
     ...
     *
     * @param {Object} data - data that shall be distributed to observers
     */
     ...
     *
     * @param {Object} event - event that is to be handled by the game on the server
     */
