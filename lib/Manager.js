...
var ManagerModule = (function() {
     ...
     *
     * @param {Object} game - game that is to be registred
     * @throws Error if no game object is supplied
     * @return {Boolean} bool - true if everything went well
     */
     ...
     *
     * @param {Object} game - game to be removed
     */
     ...
     * Get all games.
     *
     * @return {Array} games - array with all the games registred with the manager
     */
     ...
     * @return {Object} game - null or the game object with the specified id
     */
